...
#define SHORT_PERIOD_MS 6   // was 22
...
#define CAPTURE_MAIN_MIC_VOLUME 0
#define CAPTURE_SUB_MIC_VOLUME 0
...
#define CAMCORDER_MAIN_MIC_VOLUME 0
#define CAMCORDER_SUB_MIC_VOLUME 0
#define CAMCORDER_HEADSET_MIC_VOLUME 0
